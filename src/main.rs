...
use server::*;
use utils::{load_abi_from_file, AppState, ConfigManager};
...
async fn main() -> Result<()> {
    ...
    let app_data = Data::new(AppState {
        ...
        enclave_store_contract_addr: config.enclave_store_contract_addr,
        ...
        secret_storage_contract_abi: load_abi_from_file()?,
        ...
        secrets_txn_sender_channel: None.into(),
    });
